<div class="panel card">
    ...
    <div class="panel-body card-body">
        {if isset($voucher_img) && $voucher_img}
            ...
            <div class="row">
                <div class="col-lg-6">
                    <a href="{$voucher_img}" target="_blank" title="{l s='Ver imagen completa' mod='qrpayment'}">
                        <img src="{$voucher_img}" class="img-thumbnail" style="max-width: 400px; border: 1px solid #ccc;" />
                    </a>
                </div>
            </div>
        {else}
